    ...
    */
    class User extends CI_Controller 
    {
        ...
        public function index($nowpage=1){
            ...
            if($_SESSION['bfdyt_role']==0){
                ...
                if($_SESSION['bfdyt_role']==1){
                    ...
                    $notrole = $_SESSION['bfdyt_role']==4? 5 : 4 ;
                    $where = ' bfdyt_fid='.$_SESSION['bfdyt_fid'].' and bfdyt_role !="'.$notrole.'"';
                    echo $where;
                }
            }
            //分页
        ...
        public function add(){
            ...
            if($_SESSION['bfdyt_role']==0){
                ...
                $data['leader'][0] = $_SESSION; 
                 ...
                 $this->db->select('bfdyt_id,bfdyt_fid,bfdyt_name,bfdyt_username');
                $query = $this->db->get_where('bfdyt_user',array('bfdyt_id'=>$_SESSION['bfdyt_fid'],'bfdyt_role'=>'1'));
                $data['leader'] = $query->result_array();
            }
        ...
        public function doadd(){
            ...
            $data['bfdyt_role']=isset($role)?$role:exit('0');
