    ...
    class Student extends CI_Controller 
    {
        ...
        */
	    ...
	    //省份筛选
            ...
            if(isset($_GET['startime'])&&$_GET['startime']){
                ...
                $stimewhere = ' AND i.bfdyt_zxdate >= "'.$startime.'" ';
            ...
            if(isset($_GET['endtime'])&&$_GET['endtime']){
                ...
                $etimewhere = ' AND i.bfdyt_zxdate <= "'.$endtime.'" ';
            ...
            $query = $this->db->query($sql.' order by i.bfdyt_zxdate desc '.$limit);
            // echo '<pre>';
        ...
        */
        public function indexfront($nowpage=1){
            ...
            $query = $this->db->query($sql.' order by i.bfdyt_id desc '.$limit);
            //获取后台网聊客服信息
        ...
        public function publicinfo($nowpage = 1){
            ...
            $offset = ($nowpage-1)*$num;
            $limit = ' limit '.$offset.','.$num;
            $orderby = ' order by i.bfdyt_id desc';
