<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
       <div style="margin: 0 auto;text-align: center;padding-top:60px;">
                ...
                <a href="javascript:;" data-url="/student/index/<?=$prepage?>/?visit=<?=$visit?>&search=<?=$search?>"class="content button border-main" id="Previous"> 上一页</a>
                <a href="javascript:;" data-url="/student/index/<?=$nextpage?>/?visit=<?=$visit?>&search=<?=$search?>"class="content button border-main" id="next"> 下一页</a>
...
<script type="text/javascript">
 ...
 ?>
    ...
    $('#searchButton').click(function(){
        ...
        if(search){
            get_content('/student/indexfront/?search='+search+'&visit=<?=$visit?>');
        }else{
            alert('请输入搜索条件');
        }
    })
