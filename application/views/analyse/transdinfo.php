...
<div class="admin bouncein"><div class="panel admin-panel">
    ...
    <script>
        ...
        var monthdata = <?php echo $monthjson?$monthjson:'""';?>;
        var citydata = <?php echo $cityjson?$cityjson:'""';?>;
        for(var i=0;i<citydata.length;i++){
            citydata[i].name=(getAreaNamebyID(String(citydata[i].name))).substr(3);
        }
        var option = {
        ...
        if (option && typeof option === "object") {
         ...
         $(function(){
            $('#endTime,#starTime').change(function(){
                ...
                get_content('/analyse/transdinfo?start='+starTime+'&end='+endTime);
            })
        })
    </script>
</div>
